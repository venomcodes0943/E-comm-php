...
if (isset($_POST['update'])) {
    ...
    $p_tax = $_POST['p_tax'];
    $p_dics = $_POST['p_dics'];
    $sql = "UPDATE `product` SET `p_name`='$p_name',`p_price`='$p_price',`p_tax`='$p_tax',`p_dics`='$p_dics' WHERE `id` = '$pid'";
...
<head>
    <meta charset="utf-8" />
    <title>Validation | Parsley | Adminto - Responsive Admin Dashboard Template</title>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" class="parsley-examples">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="p_name" value="<?php echo $row['p_name'] ?>" required placeholder="Enter Product name" class="form-control" id="userName" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="emailAddress" class="form-label">Product Price<span class="text-danger">*</span></label>
                                            <input type="text" name="p_price" value="<?php echo $row['p_price'] ?>" required placeholder="Enter Product Price" class="form-control" id="emailAddress" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="pass1" class="form-label">TAX<span class="text-danger">*</span></label>
                                            <input id="pass1" type="text" name="p_tax" value="<?php echo $row['p_tax'] ?>" placeholder="Set Tax" required class="form-control" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="passWord2" class="form-label">Product Discription <span class="text-danger">*</span></label>
                                            <textarea name="p_dics" id="" cols="30" rows="10" class="form-control"><?php echo $row['p_dics'] ?>
                                        </textarea>
                                        </div>
                                        <div class="text-end">
                                            <button class="btn btn-primary waves-effect waves-light" type="submit" name="update">Submit</button>
                                        </div>
                                    </form>
                                </div>
                            </div> <!-- end card -->
